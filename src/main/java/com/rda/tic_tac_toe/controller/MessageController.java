...
import com.rda.tic_tac_toe.manager.TicTacToeManager;
import com.rda.tic_tac_toe.model.TicTacToe;
import com.rda.tic_tac_toe.model.dto.JoinMessage;
import com.rda.tic_tac_toe.model.dto.PlayerMessage;
import com.rda.tic_tac_toe.model.dto.TicTacToeMessage;
        ...
        if (game != null) {
            if (game.getPlayer1().equals(player)) {
                ...
                if (game.getPlayer2() != null) {
                    game.setGameStatus(GameStatus.PLAYER2_WON);
                ...
                if (game.getPlayer1() != null) {
                    game.setGameStatus(GameStatus.PLAYER1_WON);
